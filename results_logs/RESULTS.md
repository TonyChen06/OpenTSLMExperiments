...
Per-epoch logs: `results_logs/boxA_*.txt`. train/val = at best-val epoch. acc=accuracy, F1=macro-F1 (CoT).

| model | task | best-ep | train loss | val loss | acc | F1 |
|---|---|---|---|---|---|---|
| mamba-1.4b | TSQA | 40 | 0.0007 | 0.0018 | 0.9981 | — |
| mamba-1.4b | HAR | 18 | 0.3898 | 0.5238 | 0.7192 | 0.6709 |
| mamba-1.4b | Sleep | 10 | 0.3959 | 0.5519 | 0.8712 | 0.6081 |
| SP | TSQA | 14 | 0.0489 | 0.0406 | 0.9240 | — |
